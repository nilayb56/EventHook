...
public class AttndAdapter extends ArrayAdapter<Attendance> {
    ...
    public AttndAdapter(@NonNull Context context, int resource, @NonNull List<Attendance> users) {
    ...
    static class ViewHolder {
        TextView lblAtGrpName;
        TextView lblAtContName;
        CheckBox chkContAttend;
    }
